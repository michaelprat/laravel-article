...
<html lang="en">
  <head>
    ...
    <title>GUDAO -THE GACHA MANIAC</title>
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html">GUDAO</a>
        </div>
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="work.html">Summoned Servant</a></li>
            <li><a href="about.html">About</a></li>
            <li><a href="blog.html">Other Games played</a></li>
	    ...
	    <div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 centered">
					<img src="{{asset('Portofolio/img/user.png')}}" alt="Stanley">
					<h1>Hi, I am Gudao!</h1>
	...
	<div class="container pt">
		<div class="row mt centered">	
			...
			<div class="col-lg-4">
				<a class="zoom green" href="work01.html"><img class="img-responsive" src="{{asset('Portofolio/img/portfolio/port02.jpg')}}" alt="" /></a>
				<p>RAIDERS</p>
			</div>
			<div class="col-lg-4">
		...
		<div class="row mt centered">	
			...
			<div class="col-lg-4">
				<a class="zoom green" href="work01.html"><img class="img-responsive" src="{{asset('Portofolio/img/portfolio/port06.jpg')}}" alt="" /></a>
				<p>CHIEFS</p>
			</div>
		</div><!-- /row -->
	</div><!-- /container -->
